...
a full list of npm packages that would be the starter kit for this applications frontend software will be found in this repositories **crpytidex/package.json** directory.
...
-npm package https://www.npmjs.com/package/@authing/guard-react
